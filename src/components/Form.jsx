      ...
      >
        ...
        <div className="flex flex-wrap -mx-3 mb-2">
          <div className="w-full px-3">
            ...
            <input
              className="appearance-none block w-full bg-transparent text-whitePastel border border-blue-100 rounded mb-3 leading-tight focus:outline-none file:mr-4 file:py-2 file:bg-gray-800 file:border-none file:text-whitePastel file:rounded text-sm focus:bg-white focus:bg-opacity-5"
              id="file_input"
              name="foto"
              type="file"
